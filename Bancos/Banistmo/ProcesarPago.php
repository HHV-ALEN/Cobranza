...
if ($record):
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <?php if ($record['debito']): ?>
                            <p class="card-text"><strong>Débito:</strong> <?php echo $record['debito']; ?></p>
                        <?php endif; ?>
                        <?php if ($record['credito']): ?>
                            <p class="card-text"><strong>Crédito:</strong> <?php echo $record['credito']; ?></p>
                        <?php endif; ?>
    ...
    if ($record):
        ...
        <div class="container mt-5 fade-in">
            ...
            <hr>
            <form action="/Back/ProcesoPagos/Proceso_Pago_Banistmo.php?id_pago=<?php echo $id ?> &Metodo=Actualizar"
    ...
    <?php else: ?>
        ...
        <div class="container mt-5 fade-in">
            ...
            <form action="/Back/ProcesoPagos/Proceso_Pago_Banistmo.php?id_pago=<?php echo $id ?>&Metodo=Registrar" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="Banco" value="Banistmo">
