...
$sql = "SELECT * FROM movimientos_santander WHERE Id = $id";
...
if ($record):
    ...
    <head>
        ...
        <title>Proceso de Pago - Banistmo</title>
            ...
            <div class="row text-center">
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <?php if ($record['Abono']): ?>
                            <p class="card-text"><strong>Débito:</strong> <?php echo $record['Abono']; ?></p>
                        <?php endif; ?>
                        <?php if ($record['Cargo']): ?>
                            <p class="card-text"><strong>Crédito:</strong> <?php echo $record['Cargo']; ?></p>
                        <?php endif; ?>
    ...
    if ($record):
        ...
        <div class="container mt-5 fade-in">
            ...
            <hr>
            <form action="/Back/ProcesoPagos/Proceso_Pago_Santander.php?id_pago=<?php echo $id ?> &Metodo=Actualizar"
    ...
    <?php else: ?>
        ...
        <div class="container mt-5 fade-in">
            ...
            <form action="/Back/ProcesoPagos/Proceso_Pago_Santander.php?id_pago=<?php echo $id ?>&Metodo=Registrar" method="POST" enctype="multipart/form-data">
