...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($Metodo == 'Registrar') {
        ...
        VALUES ('$id_pago', '$numero_pago', '$numero_factura', 'Banistmo', '$tipo', 'Usuario', '$FechaActual', '$cliente', '$banco', '$nombre_archivo_xml')";

        if ($conn->query($Insert_SQL) === TRUE) {
            echo "Registro creado correctamente";
            /// Actualizar estado del pago en la tabla de movimientos
            $Update_SQL = "UPDATE movimientos_base SET Estado = 'Procesado' WHERE Id = '$id_pago'";
...
//Regresar Al listado
header ("Location: ../../Bancos/Base/Listado.php");
